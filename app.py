...
def get_image(filename):
    return render_template('image.html', filename=filename, title='Image', url='https://rakhmat.ninja/images/uploads/' + filename, og_image='https://rakhmat.ninja/images/uploads/' + filename, og_title='Image', og_description='Image', og_url='https://rakhmat.ninja/images/uploads/' + filename, og_type='image', og_site_name='Image', og_description='Image')
